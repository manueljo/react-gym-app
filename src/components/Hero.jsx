  ...
  return (
    <div className="min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-[900px] w-full mx-auto p-4">
      ...
      <p className="text-sm md:text-base font-light">
        ...
        <span className="text-blue-400 font-medium"> unbelievably swolenormous 
      ...
      <button className="px-8 py-4 rounded-md border border-blue-400 border-solid border-[2px] bg-slate-950 blueshadow duration-200">
        <p>Accept & Begin</p>
      </button>
    </div>
  );
